...
<body>
<h1 class="h1_style"><i class="i_h1"></i>旅行社信息</h1>
<div class="div_left">
    ...
    <form id="form_demo"  class="form_b">
        ...
        <p class="form_p"><label class="form_label">旅行社名称：</label><input type="text" class="form_input " minlength="2"  required ><i class="i_start"></i> </p>
